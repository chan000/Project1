               ...
               <div class="container mt-3">
                  ...
                  <div class="row">
                  	<br>
              			...
              			<input type="text" name="keyword" id="keywordInput" placeholder="양식명으로 검색" value="${cri.keyword}">
                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      ...
                      <div class="form-group ">
                        ...
                        <div class="col-md-10 col-lg-10">
                          <input class="form-control" id="finfo" name="finfo" type="text" required />
                        </div>
						</div>
                      </div>
  ...
  <script src="/resources/js/fullcalendar.min.js"></script>
    ...
    $(document).ready(function() {
		...
		function getFormList(){
		    $.getJSON("/form/all?page=" + pageNum + "&keyword=" + keyword, function(data) {
			    var str = "";
		    	$(data).each(
		    		function() {
// 		    			console.log(this);
		    			...
		    			str += "<tr data-fno='" + this.fno + "' class='text-center myfno' data-fname='" + this.fname + "' data-finfo='" + this.finfo + "'>"
...
// 			$.getJSON("/form/paging?page=" + pageNum + "&keyword=" + keyword, function(data) {
// 				var str = "";
// 				totalCount = data;
// 				console.log(totalCount);
...
// 				var tempEndPage = Math.ceil(totalCount / 10);
...
// 					str += "<ul class='pagination'><li><a href='/manage/formmanage?page=" + (startPage - 1)
// 						+ "&keyword=" + keywword + "'>«</a></li>
// 				}
