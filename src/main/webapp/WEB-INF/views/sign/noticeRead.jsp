              ...
              <div class="panel-body">
                <form action="target" class="form-horizontal " method="get">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-11">
                      <input type="text" class="form-control" readonly="true" name="nno" value="${noticeRead.bno}">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-1 control-label">부서명</label>
                    <div class="col-sm-11">
                      <input type="text" class="form-control" readonly="true" value="임시">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-1 control-label"> 제목</label>
                    <div class="col-sm-11">
                      <input type="text" class="form-control" readonly="true" value="${noticeRead.btitle}">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-1 control-label">작성자</label>
                    <div class="col-sm-11">
                      <input class="form-control" id="focusedInput" type="text" readonly="true" value="${noticeRead.bwriter}">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-1 control-label">작성일</label>
                    <div class="col-sm-11">
                      <input class="form-control" id="disabledInput" type="text" readonly="true" value="${noticeRead.bwrite_date}">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-11">
                      <textarea class="form-control" readonly="true" cols="30" rows="10">${noticeRead.bcontent}</textarea>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <a class="btn btn-primary col-md-1" style="margin-right:5px; margin-left: 50px;" href="" title="Bootstrap 3 themes generator">목록</a>
