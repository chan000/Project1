      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
             ...
             <c:forEach var="mydoculist" items="${mydocu}">
             <input type="hidden" name="fno" value="${mydoculist.fno }">
             <tr>
		          <td>${mydoculist.fno }</td>
		          <td><a href="/mymenu/myreport?fno=${mydoculist.bno }">${mydoculist.btitle }</a></td>
		          <td>${mydoculist.bcontent }</td>
		          <td>${mydoculist.bwrite_date }</td>
		      </tr>
             </c:forEach>
