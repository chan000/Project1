              ...
              <header class="panel-heading">
                내 정보 수정
							...
							<select class="form-control" onchange="location.href=this.value" id="mno"
								name="mno">
								<option value="/mymenu/list">선택</option>
								<option value="/mymenu/mget?mno=1">1</option>
								<option value="/mymenu/mget?mno=2">2</option>
								<option value="/mymenu/mget?mno=3">3</option>
							</select>
