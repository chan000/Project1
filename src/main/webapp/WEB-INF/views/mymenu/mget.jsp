...
<meta name="keyword"
	content="Creative, Dashboardberget, Admin, Template, Theme, Bootstrap, Responsive, Retina, Minimal">
          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form">
                  <form class="form-validate form-horizontal" action="/mymenu/mmodify">
               	<input type="hidden" name="mno" value="${board.mno }">
                    <div class="form-group ">
                      ...
                      <label for="boardbername" class="control-label col-lg-2 col-lg-offset-1">이름 <span
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-6">
                        <input class="form-control"  name="board" value="${board.memail }" />
                      </div>
                    </div>
                    <div class="form-group ">
                    ...
                    <div class="form-group">
                      <div class="col-lg-offset-2 col-lg-10">
							<button class="btn btn-primary useboard" type="submit" data-oper="modify">수정</button>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$('.useboard').on("click", function(e){
				...
				if(operation === "modify"){
					formObj.attr("action", "/mymenu/mmodify");
				}
				formObj.submit(); 
			});
		});
