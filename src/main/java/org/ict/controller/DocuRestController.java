...
public class DocuRestController {
	...
	public ResponseEntity<Map<String, Object>> boardListPageSearch(@PathVariable ("page") int page, @PathVariable ("searchType") String searchType ,@PathVariable ("keyword") String keyword){
